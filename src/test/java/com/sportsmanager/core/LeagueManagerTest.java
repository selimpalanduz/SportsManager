...
public class LeagueManagerTest {
    ...
    void leagueShouldHaveCorrectTeamCount() {
        League league = leagueManager.createLeague("Test League", Arrays.asList(team1, team2, team3));
    ...
    void initialPointsShouldBeZero() {
        League league = leagueManager.createLeague("Test League", Arrays.asList(team1, team2));
        List<StandingsEntry> standings = leagueManager.calcStandings(league);
    ...
    void winShouldGiveThreePoints() {
        StandingsEntry entry = new StandingsEntry(team1);
        entry.addResult(2, 0);
